    ...
    <main className="flex min-h-screen flex-col items-center justify-between bg-white">
      <div className="w-full h-full flex items-center justify-center flex-col mb-10 relative">
        ...
        ><Image
            ...
            priority
          /></button></div>
        <div className={`absolute mt-44 rounded-3xl flex-col menu-bar ${menuBar ? 'flex' : 'hidden'}`} style={{ width: "420px", height: '420px' }}>
        ...
        <div className="flex items-center justify-center flex-col mt-10 pt-3 pb-3 rounded-lg build-container shadow-xl" style={{ width: '240px' }}><p className="font-medium text-white text-center">Build your own voice agent</p><p className="font-medium">‘It’s free!’</p></div>
        <div className="flex items-center justify-center flex-col mt-4 pt-3 pb-3 rounded-lg font-semibold text-xl border-solid border border-gray-600" style={{ width: '240px' }}>Hear it in action</div>
      </div>
      <div className="w-full h-full flex items-center justify-center flex-col mt-10 mb-10">
        <div className=" flex items-center justify-center flex-col rounded-2xl try-now-container mt-10" style={{ width: '300px', height: '460px' }}>
          <div className="flex flex-col justify-evenly mt-10 mb-10">
            ...
            <input className="p-1 pt-2 pb-2 pl-4 rounded-lg bg-transparent mt-3 border-solid border border-gray-700 text-sm" type="text" placeholder="Name"></input>
            <div className="relative"><input type="text" className="p-1 pt-2 pb-2 rounded-lg bg-transparent mt-5 border-solid border border-gray-700 pl-16 text-sm relative" placeholder="+91"></input>
            ...
            <select className="p-1 pt-2 pb-2 rounded-lg bg-transparent mt-5 border-solid border border-gray-700 pl-3 text-gray-600 mb-10 text-sm minimal" style={{ color: '#989898' }} name="" id="">
              <option value="null" className="text-gray-400">Choose your language</option>
            </select>
            <div className="flex items-center justify-center mt-10"><button className="flex items-center justify-center rounded-full" style={{ width: '45px', height: '45px', backgroundColor: "#FF9345B0" }}><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex items-center justify-center flex-col">
        ...
        />
          ...
          <Image
            ...
            priority
          /></div>
        <div className="flex items-center justify-center mt-10 mb-10 text-white text-center" style={{ width: '300px', height: '350px', background: 'black' }}>
          Video
        </div>
      </div>
      <div className=" flex items-center mt-5 flex-col rounded-lg mb-5" style={{ width: '380px', height: '550px', background: '#FFF6E8' }}>
        <div className="mt-5 mb-2" style={{
          width: '250px', height: '220px', overflow: 'hidden', alignItems: 'center',
        }}>
          <Image
        ...
        <button className="text-sm rounded-md explore-button p-2 mb-5 mt-1" style={{ width: '100px', height: '50px' }}>Explore more</button>
      </div>
      <div className="mt-20 mb-10 relative sliders">
        <hr className="hr" />
        <div className="flex items-center justify-center flex-col">
          <Image
        ...
        <hr className="hr" />
        <div className='absolute vr' style={{ top: '-60px', left: '55px' }}></div>
        <div className='absolute vr' style={{ top: '-60px', right: '55px' }}></div>
      </div>
      ...
      <div>{slider.map((value, index) => (<button className={`ml-2 rounded-full slider-btn ${index === 0 ? 'sliders-bg' : ''}`} style={{ width: '20px', height: '20px', background: 'black' }} onClick={() => {
      ...
      <div className="flex items-center justify-center flex-col m-10">
        ...
        <div>{sliderbar.map((value, index) => (<button className={`ml-2 rounded-full slider-btn-bar ${index === 0 ? 'sliders-bg' : ''}`} style={{ width: '20px', height: '20px', background: 'black' }} onClick={() => {
      ...
      <div className="flex items-center justify-center flex-col ml-20 mr-20 mb-10">
        <Image
        ...
        <div className="flex justify-evenly mt-10 w-full"><div className="flex items-center justify-center flex-col text-center text-sm font-medium"><section className="rounded-full flex items-center justify-center" style={{ width: '40px', height: '40px', background: '#ED6705' }}>
      ...
      <div className="pt-10" style={{
        width: '100%', height: '100%', background: 'linear-gradient(180deg, #FFD6B8 0%, rgba(153, 145, 139, 0) 100%)'
      }}>
